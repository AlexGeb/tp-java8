...
public class Stream_06_Test {
	...
	private long iterateSum(long n) {
		return Stream.iterate(1L, i -> i + 1).limit(n - 1).reduce(0L, (i1, i2) -> i1 + i2);
	}
	...
	private long parallelIterateSum(long n) {
		return Stream.iterate(1L, i -> i + 1).parallel().limit(n - 1).reduce(0L, (i1, i2) -> i1 + i2);
	}
	...
	public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum() {
		Logger.getAnonymousLogger().info("imperativeSum => " + monitor(this::imperativeSum, /* NB */ 10) + " ms");
		Logger.getAnonymousLogger().info("iterateSum => " + monitor(this::iterateSum, /* NB */ 10) + " ms");
		Logger.getAnonymousLogger()
				.info("parallelIterateSum => " + monitor(this::parallelIterateSum, /* NB */ 10) + " ms");
	}
	...
	private long rangeSum(long n) {
		return LongStream.rangeClosed(0, n - 1).reduce(0, (l1, l2) -> l1 + l2);
	}
	...
	private long rangeParallelSum(long n) {
		return LongStream.rangeClosed(0, n - 1).parallel().reduce(0, (l1, l2) -> l1 + l2);
	}
	...
	public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum_vs_rangeSum_vs_rangeParallelSum() {
		Logger.getAnonymousLogger()
				.info("imperativeSum => " + /* TODO */monitor(this::imperativeSum,NB) + " ms");
		Logger.getAnonymousLogger()
				.info("iterateSum => " + /* TODO */monitor(this::iterateSum, NB) + " ms");
		Logger.getAnonymousLogger()
				.info("parallelIterateSum => " + /* TODO */monitor(this::parallelIterateSum, NB ) + " ms");
		Logger.getAnonymousLogger().info("rangeSum => " + /* TODO */monitor(this::rangeSum, NB) + " ms");
		Logger.getAnonymousLogger()
				.info("rangeParallelSum => " + /* TODO */monitor(this::rangeParallelSum, NB) + " ms");
	}
